...
class MPC:
    ...
    def get_trajectory(self, x_init, x_des):
        # given a current and desired state, return a trajectory that solves the state
        # tracking trajectory optimization problem
        ...
        self.sol_x_prev, self.sol_u_prev, self.sol_f_prev = sol_x, sol_u, sol_f
